...
def test_cloud_fraction():
    ...
    cloud_fraction_0 = cloudmetrics.cloud_fraction(cloud_mask_0)
    cloud_fraction_1 = cloudmetrics.cloud_fraction(cloud_mask_1)
    cloud_fraction_2 = cloudmetrics.cloud_fraction(cloud_mask_2)
